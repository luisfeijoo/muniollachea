<div style="background: #05102b;" class="mt3">
    <footer class="container footer-distributed">
        <div class="footer-left">
            <h3><a href="/"><img src="{{ url('img/logo_muniollachea.png') }}" alt="Logo de la Municipalidad Distrital de Ollachea" width="50%"></a></h3>
            ...
            <p class="footer-company-name"><strong class="has-text-grey">Alcalde: </strong>Dr. Carlos A. Nina Alférez.<br>Municipalidad de Ollachea © 2020</p>
        </div>

        <div class="footer-center">
            <div>
                <i class="fal fa-map-marker"></i>
                <p><span>Plaza de armas S/N</span>Ollachea, Carabaya, Puno.</p>
            </div>
            ...
            <div>
                ...
                <p><span>ATENCIÓN: Lunes - Viernes.</span>Mañanas. 8AM - 12AM<br>Tardes. 2PM-5PM</p>
            </div>
        </div>
        <div class="footer-right">
            <p class="footer-company-about">
                <span>Gestión 2019-2022</span>
